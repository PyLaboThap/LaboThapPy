...
class RadialCPMLDesign(object):
    ...
    def designRotor(self):
        ...
        self.params['r2'] = r2 = u2/self.inputs['Omega']
        
        # Determine r1s, r1h, pitch1 and b2 from r2
        self.params['pitch1'] = pitch1 = r2/self.n_blade_R
        self.params['r1s'] = r1s = r2*self.inputs['r1s_r2']
        self.params['r1h'] = r1h = r1s*self.inputs['r1h_r1s']
        self.params['b2']  = r2*self.inputs['b2_r2']
        
        self.params['r1'] = r1 = (r1s + r1h)/2
        self.Vel_Tri_R['u1'] = u1 =self.inputs['Omega']*r1
        
        # Rotor inlet velocity triangle
        self.A1_th = (r1s - r1h)*pitch1
        self.Vel_Tri_R['v1'] = v1 = self.inputs['mdot']/(self.total_states['D'][1]*self.A1_th)
        self.Vel_Tri_R['alpha1'] = alpha1 = 0
        self.Vel_Tri_R['vm1'] = vm1 = v1*np.cos(alpha1)
        
        self.Vel_Tri_R['beta1'] = beta1 = np.arctan(vm1/u1)
        self.Vel_Tri_R['w1'] = vm1/np.cos(beta1)
    ...
    def designSystem(self):
        ...
        self.n_blade_R = np.ceil(12.03 + 2.544*self.PR) # Without splitter
