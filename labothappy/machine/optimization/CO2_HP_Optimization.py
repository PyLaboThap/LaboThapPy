...
#             self.HP = IHX_EXP_CO2_HP(self.HSource, self.CSource, self.params['eta_cp'], self.params['eta_gc'], self.params['eta_IHX'], self.params['eta_exp'], self.params['PP_ev'], self.params['SH_ev'], P_low_guess, self.it_var['P_high'], self.it_var['mdot'], mute_print_flag = 0)
            
#         elif self.params['HP_ARCH'] == 'IHX':
#             self.HP = IHX_CO2_HP(self.HSource, self.CSource, self.params['eta_cp'], self.params['eta_gc'], self.params['eta_IHX'], self.params['PP_ev'], self.params['SH_ev'], P_low_guess, self.it_var['P_high'], self.it_var['mdot'], mute_print_flag = 0)
...
#         if self.params['HP_ARCH'] == 'IHX_EXP':     
#             self.COP = CO2_HP.components['GasCooler'].model.Q_dot.Q_dot/(CO2_HP.components['Compressor'].model.W.W_dot - CO2_HP.components['Expander'].model.W.W_dot)
...
#%% Cycle Set
    ...
    def set_HP(self):
        ...
        if self.params['HP_ARCH'] == 'IHX_EXP':
            self.HP = IHX_EXP_CO2_HP(self.HSource, self.CSource, self.params['eta_cp'], self.params['eta_gc'], self.params['eta_IHX'], self.params['eta_exp'], self.params['PP_ev'], self.params['SH_ev'], P_low_guess, self.it_var['P_high'], self.it_var['mdot'], mute_print_flag = 1)
            
        elif self.params['HP_ARCH'] == 'IHX':
            self.HP = IHX_CO2_HP(self.HSource, self.CSource, self.params['eta_cp'], self.params['eta_gc'], self.params['eta_IHX'], self.params['PP_ev'], self.params['SH_ev'], P_low_guess, self.it_var['P_high'], self.it_var['mdot'], mute_print_flag = 1)
