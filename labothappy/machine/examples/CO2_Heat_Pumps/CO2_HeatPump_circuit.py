...
def basic_CO2_HP(HSource, CSource, eta_cp, eta_gc, PP_ev, SH_ev, P_low, P_high):
    ...
    CO2_HP.link_components("Evaporator", "m-ex", "Compressor", "m-su")
...
if __name__ == "__main__":
    ...
    if study_case == "IHX":
        ...
        COP = CO2_HP.components["GasCooler"].model.Q.Q_dot/(CO2_HP.components["Compressor"].model.W.W_dot - CO2_HP.components["Expander"].model.W_exp.W_dot)
