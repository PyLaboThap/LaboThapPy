...
if __name__ == "__main__": 
    ...
    if study_case == "Simple":
        ...
        CO2_TC.plot_thermo_cycle(axes = 'Ts')
        ...
        eta = (CO2_TC.components['Expander'].model.W_exp.W_dot - CO2_TC.components['Pump'].model.W.W_dot - CO2_TC.components['Compressor'].model.W.W_dot)/(CO2_TC.components['GasHeater'].model.Q)
