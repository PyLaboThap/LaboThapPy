...
def preheated_rec_orc(fluid, CSource, HSource, PREsource, P_high, P_low, m_dot, eta_pp, eta_exp, PP_cd, SC_cd, PP_ev, SH_ev, eff_rec):
    ...
    orc.set_source_properties(T=CSource.T, fluid='Water', P=CSource.p, m_dot = CSource.m_dot, target="CD_Water")
    
    orc.add_source("EV_Water", HSource, orc.components["Evaporator"], "m-su_H")
    orc.set_source_properties(T=HSource.T, fluid='Water', P=HSource.p, m_dot = HSource.m_dot, target="EV_Water")
    
    orc.add_source("PRE_Water", PREsource, orc.components["Preheater"], "m-su_H")
    orc.set_source_properties(T=PREsource.T, fluid='Water', P=PREsource.p, m_dot = PREsource.m_dot, target="PRE_Water")
