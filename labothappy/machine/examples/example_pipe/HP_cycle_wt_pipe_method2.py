...
Pipe_Compressor_to_Condenser = Pipe()
Condenser = HexCstPinch()
Pipe_Condenser_to_ExpansionValve = Pipe()
ExpansionValve = ValveIsenthalpic()
Pipe_ExpansionValve_to_Evaporator = Pipe()
Evaporator = HexCstPinch()
Pipe_Evaporator_to_Compressor = Pipe()
...
# Pipes geometries
Pipe_Compressor_to_Condenser.add_straight(D=0.012, L=1.0, theta = 0).add_curved_elbow(D=0.012, delta=90, R0_D=1.5).add_straight(D=0.012, L=0.5, theta = 90) # 10mm diameter, 1.5m long
Pipe_Condenser_to_ExpansionValve.add_straight(D=0.012, L=1.0, theta = 0)
Pipe_ExpansionValve_to_Evaporator.add_curved_elbow(D=0.012, delta=90, R0_D=1.5)
