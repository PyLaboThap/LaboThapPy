...
if case_study == "Simple":
    ...
    CO2_HP.set_source_properties(T=60 + 273.15, fluid='Water', m_dot=1, target='GC_Water', P = 3e5)
    
    EV_source = MassConnector()
    CO2_HP.add_source("EV_Water", EV_source, CO2_HP.components["Evaporator"], "m-su_H")
    CO2_HP.set_source_properties(T=15 + 273.15, fluid='Water', m_dot=1, target='EV_Water', P = 2e5)
...
if case_study == "IHX":
    ...
    Gas_cooler_source = MassConnector()
    CO2_HP.add_source("GC_Water", Gas_cooler_source, CO2_HP.components["GasCooler"], "m-su_C")
    CO2_HP.set_source_properties(T=60 + 273.15, fluid='Water', m_dot=2, target='GC_Water', P = 3e5)
    
    EV_source = MassConnector()
    CO2_HP.add_source("EV_Water", EV_source, CO2_HP.components["Evaporator"], "m-su_H")
    CO2_HP.set_source_properties(T=15 + 273.15, fluid='Water', m_dot=2, target='EV_Water', P = 2e5)
