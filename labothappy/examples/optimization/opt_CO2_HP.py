...
from examples.machine.CO2_HeatPump_circuit import basic_CO2_HP, IHX_CO2_HP
...
HSource.set_properties(fluid = 'Water', T = T_hot_source, p = 3e5, m_dot = 3)
