...
#     AU_amb=5.4, AU_su_n=2.44, AU_ex_n=29, d_su1=8.06e-3 , m_dot_n=0.1,
#     A_leak=7.77e-06, W_dot_loss_0=9.46e-01, alpha= 2.11e-1, C_loss=1.35, rv_in=1.7, V_s=0.0000712, mode='P_N'
# )
...
#             A_leak=1.00000000e-10, W_dot_loss_0=8.19123951e-01, alpha= 7.79756524e-02, C_loss=4.68294054e-01, rv_in=1.7, V_s=3*0.000712,
#             mode = 'P_M')

expander.set_parameters(AU_amb=9.3, AU_su_n=0, AU_ex_n=17.7, d_su1=6.48e-3, m_dot_n=0.1, 
            A_leak=9.99e-06, W_dot_loss_0=2.37e+1 , alpha= 1.16e-1, C_loss=1.13, rv_in=1.7, V_s=2*0.0000712, mode='P_M')
# # Check the setup
expander.print_setup()

# Problem seems to be coming from the properties rather than the model itself!
