...
curves_power = [(0, 1.03), (1, 0.9), (1.5, 0.83), (2, 0.76), (3, 0.62), (3.5, 0.55)] # kW
curves_fluid = 'Water'
speed_ref = 2900
...
model.set_inputs(
    P_su=1.1e5,  # Suction pressure in Pascals
    T_su=280,  # Suction temperature in Kelvin
    # m_dot = 0.3, # Suction mass flow rate in kg/s
    P_ex=4e5,  # Exhaust pressure in Pascals
