...
pipe = Pipe()
pipe.add_straight(D=0.010, L=2.0, two_phase_correlation='MSH', void_fraction_model='Zivi').add_curved_elbow(D=0.01, delta=90, R0=0.5) #.add_straight(D=0.010, L=2.0, theta = -90) # 10mm diameter, 2m long
