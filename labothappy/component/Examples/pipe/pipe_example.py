...
pipe = Pipe()
pipe.add_straight(D=0.01, L=1.0, theta = 80).add_curved_elbow(D=0.01, delta=90, R0_D=1.5).add_straight(D=0.01, L=0.5, theta = 0.0) # 10mm diameter, 1.5m long
...
pipe = Pipe()
pipe.add_curved_elbow(D=0.01, delta=90, R0_D=1.5).add_straight(D=0.010, L=2.0, theta = -90) # 10mm diameter, 2m long
