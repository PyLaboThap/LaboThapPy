...
fluid = 'Cyclopentane'
mdot  = 3.581        # mass flow rate [kg/s]
p01   = 3190000       # inlet total pressure [Pa]
T01   = 273.15 + 220 # inlet total temperature [K]
pn    = 73630          # outlet pressure [Pa]

P = 409200 # Power to be performed [W]
...
bladeRowEfficiency = 0.686  # blade row / static-to-static efficiency (h1-h2)/(h1-h2s)
...
r_moy = 0.05 # 0.23 Iterate on this value so that AR > 1
...
#    by using velocity, density and viscosity at the blade outlet
      ...
      AR_max = min(h_blade[i]/cord_min[i]) 
