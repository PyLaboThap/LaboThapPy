    ...
    **Outputs**:
    ...
    def update_connectors(self):
        ...
        if self.params['HX_type'] == 'evaporator':
            ...
            self.ex_C.set_p(self.P_ev_x1 - self.DP_c/2)
